...
create or replace schema catalog collate latin1_swedish_ci;
use catalog;
...
create or replace table digital_products
(
	id bigint not null
		primary key,
...
create or replace table physical_products
(
...
create or replace table prod_cat_rel
(
